...
# Animation
animation_running() {
  animation_running_delay=0.5
  animation_running_dots=( '[${bold}${yellow}i${reset}]${reset} Running test.  ' '[${bold}${yellow}i${reset}]${reset} Running test.. ' '[${bold}${yellow}i${reset}]${reset} Running test...' '[${bold}${yellow}i${reset}]${reset} Running test.. ' '[${bold}${yellow}i${reset}]${reset} Running test.  ' '[${bold}${yellow}i${reset}]${reset} Running test   ' )
  # [${bold}${yellow}i${reset}]${reset} Running test...
